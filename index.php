...
$q = "SELECT * FROM staff";
$r = mysql_query($q, $hp) or die(mysql_error());
$row = mysql_fetch_assoc($r);
//var_dump($row);
//exit;
$qu = "SELECT * FROM projects";
$ru = mysql_query($qu, $hp) or die(mysql_error());
$rows = mysql_fetch_assoc($ru);
				...
				<div class="container">
					<nav class="navbar navbar-default scrollMenu" role="navigation">
						<div class="navbar-header">
							<img src="images/offlogo.JPG" class="img-responsive"/>
						...
						<div class="row">
								...
								<article class="col-sm-4 isotopeItem cats">
									<section class="imgWrapper"> 
										<img alt="" src="images/portfolio/off.jpg" class="img-responsive"> 
									</section>
									<div class="mediaHover">
										<div class="mask"></div>
										<div class="iconLinks"> 
											
											<a href="www.youtube.com/watch?v=VKxUVXX_YWI" class="image-iframe" title="Video Popup" >
					...
					<div class="container imgHover">
						<div class="row">
							...
							<article class="col-sm-4">
								...
								<section class="imgWrapper"> 
									<img src="images/news/newsk.jpg" class="img-responsive" alt="Ashleye template image news" /> 
								</section>
							...
							<article class="col-sm-4">
								<section class="imgWrapper"> 
									<img src="images/news/news2.jpg" class="img-responsive" alt="snowflake template image news" /> 
								</section>
								<div class="mediaHover">
									<div class="mask"></div>
									<div class="iconLinks"> 
				...
				<section class="slice" id="works">
					<div class="container imgHover">
						<div class="row">
							...
							<?php } while ($rows = mysql_fetch_assoc($ru)) ?>
						</div>
					</div>
					</section>
